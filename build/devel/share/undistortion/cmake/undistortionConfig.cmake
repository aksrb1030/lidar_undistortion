...
if(undistortion_CONFIG_INCLUDED)
  return()
endif()
set(undistortion_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(undistortion_SOURCE_PREFIX /home/mobiltech/catkin_ws/src/lidar_undistortion)
  set(undistortion_DEVEL_PREFIX /home/mobiltech/catkin_ws/src/lidar_undistortion/build/devel)
  set(undistortion_INSTALL_PREFIX "")
  set(undistortion_PREFIX ${undistortion_DEVEL_PREFIX})
else()
  set(undistortion_SOURCE_PREFIX "")
  set(undistortion_DEVEL_PREFIX "")
  set(undistortion_INSTALL_PREFIX /usr/local)
  set(undistortion_PREFIX ${undistortion_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'undistortion' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND undistortion_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mobiltech/catkin_ws/src/lidar_undistortion/build/devel/lib;/home/mobiltech/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(undistortion_LIBRARY_DIRS ${lib_path})
      list(APPEND undistortion_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'undistortion'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND undistortion_LIBRARIES ${lib})
    endif()
  endif()
...
set(undistortion_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${undistortion_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "geometry_msgs;nav_msgs;roscpp;rospy;std_msgs;cv_bridge")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 undistortion_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${undistortion_dep}_FOUND)
      find_package(${undistortion_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${undistortion_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(undistortion_INCLUDE_DIRS ${${undistortion_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(undistortion_LIBRARIES ${undistortion_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${undistortion_dep}_LIBRARIES})
  _list_append_deduplicate(undistortion_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(undistortion_LIBRARIES ${undistortion_LIBRARIES})

  _list_append_unique(undistortion_LIBRARY_DIRS ${${undistortion_dep}_LIBRARY_DIRS})
  list(APPEND undistortion_EXPORTED_TARGETS ${${undistortion_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${undistortion_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
